...
export const FONTS = {
    ...
    body1_medium: { fontFamily: "Poppins-Medium", fontSize: SIZES.body1, lineHeight: 36 },
    body2: { fontFamily: "Poppins-Regular", fontSize: SIZES.body2, lineHeight: 30 },
    body3: { fontFamily: "Poppins-Regular", fontSize: SIZES.body3, lineHeight: 22 },
    body4: { fontFamily: "Poppins-Regular", fontSize: SIZES.body4, lineHeight: 22 },
    body5: { fontFamily: "Poppins-Regular", fontSize: SIZES.body5, lineHeight: 20 },
    body5_medium: { fontFamily: "Poppins-Medium", fontSize: SIZES.body5, lineHeight: 20 },
    body5_bold: { fontFamily: "Poppins-Bold", fontSize: SIZES.body5, lineHeight: 20 },
